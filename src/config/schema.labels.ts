...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "browser.profiles.*.navigationPolicy": "Browser Profile Navigation Policy",
  "browser.profiles.*.navigationPolicy.allowHostnames": "Allowed Navigation Hostnames",
  "browser.profiles.*.navigationPolicy.denyHostnames": "Denied Navigation Hostnames",
